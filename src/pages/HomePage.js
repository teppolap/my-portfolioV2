...
const HomePage = () => {
  ...
  const isNavActive = (name) => {
    ...
    if (name === 'Experience') return activeSection === 'experience';
    return false;
  };
        ...
        <div className="flex flex-col min-[1263px]:flex-row min-[1263px]:justify-center min-[1263px]:items-start w-full min-[1263px]:w-4/5 mx-auto">
          ...
          >
            <div className="text-center min-[1263px]:text-left px-4 py-6 min-[1263px]:px-8 min-[1263px]:py-8 flex flex-col items-center min-[1263px]:items-start">
              ...
              <motion.div
                className="mt-8 w-full max-w-xs lg:max-w-none text-center min-[1263px]:text-left"
                variants={itemVariants}
              >
                <p className="text-xs font-semibold uppercase tracking-widest text-slate-400">
                  Interests & Hobbies
                ...
                {/* Tech Interests */}
                <div className="mt-4">
                  <p className="text-sm font-medium text-slate-300 mb-2">Tech Interests</p>
                  <div className="flex flex-wrap gap-2 justify-center min-[1263px]:justify-start">
                    <span className="px-3 py-1 text-xs bg-cyan-400/10 text-cyan-300 rounded-full border border-cyan-400/20 hover:bg-cyan-400/20 transition-colors">
                      AI & LLMs
                    </span>
                    <span className="px-3 py-1 text-xs bg-cyan-400/10 text-cyan-300 rounded-full border border-cyan-400/20 hover:bg-cyan-400/20 transition-colors">
                      Cloud Architecture
                ...
                {/* Personal Hobbies */}
                <div className="mt-4">
                  <p className="text-sm font-medium text-slate-300 mb-2">Personal Hobbies</p>
                  <div className="flex flex-wrap gap-2 justify-center min-[1263px]:justify-start">
                    <span className="px-3 py-1 text-xs bg-emerald-400/10 text-emerald-300 rounded-full border border-emerald-400/20 hover:bg-emerald-400/20 transition-colors">
                      Gaming
                    </span>
                    <span className="px-3 py-1 text-xs bg-emerald-400/10 text-emerald-300 rounded-full border border-emerald-400/20 hover:bg-emerald-400/20 transition-colors">
                      Coding Projects
          ...
          >
            ...
            <section id="experience" className="mb-24">
              ...
              >
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-slate-200">
                  Working Experience
                </h2>
              </motion.div>
              <Experience />
